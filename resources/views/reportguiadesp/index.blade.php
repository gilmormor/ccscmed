...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/reportguiadesp/index.js")}}" type="text/javascript"></script>
                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data-consulta" data-page-length="25">
                    <thead>
                        <tr>
                            ...
                            <th class="ocultar">guiadespanul_obs</th>
                            <th class="ocultar">guiadespanulcreated_at</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
