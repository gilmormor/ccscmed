...
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
    ...
    <div class="dd3-content {{$item["url"] == "javascript:;" ? "font-weight-bold" : ""}}">
        <a href="{{route("editar_menu", ['id' => $item["id"]])}}" class="tooltipsC" title="Editar este menú"><i style="font-size:20px;" class="fa fa-fw {{isset($item["icono"]) ? $item["icono"] : ""}}"></i> | {{$item["nombre"] . " | Url: " . $item["url"]}}</a>
