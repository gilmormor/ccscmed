...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/dtendfactura/index.js")}}" type="text/javascript"></script>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Notas de debito DTE por Generar</h3>
                <div class="box-tools pull-right">
                    <a href="{{route('crear_dtendfactura')}}" class="btn btn-block btn-success btn-sm">
                        <i class="fa fa-fw fa-plus-circle"></i> Nueva Nota Debito
                    </a>
                </div>
            </div>
            <div class="box-body">
