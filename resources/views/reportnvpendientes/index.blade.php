    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Notas de Ventas Pendientes</h3>
                        ...
                        <div class="col-xs-12 col-md-9 col-sm-12" style="padding-left: 0px;padding-right: 0px;">
                            ...
                            <div class="col-xs-12 col-md-12 col-sm-12">
                                <div class="col-xs-12 col-sm-6" data-toggle='tooltip' title="Producto">
                                    <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                        <label for="producto_idPxP" class="control-label" title="F2 Buscar">Producto</label>
                                    </div>
                                    <div class="col-xs-12 col-md-8 col-sm-8">
                                        <div class="input-group">
                                            <input type="text" name="producto_idPxP" id="producto_idPxP" class="form-control" tipoval="numericootro" value="{{old('producto_idPxP', $clienteselec[0]->producto_idPxP ?? '')}}" placeholder="F2 Buscar"/>
                                            <span class="input-group-btn">
