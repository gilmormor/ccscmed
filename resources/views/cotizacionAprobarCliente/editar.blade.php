    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Aprobar Cliente Cotización Nro.: {{$data->id}}</h3>
            ...
            <form action="{{route('actualizar_CotizacionAprobarCliente', ['id' => $data->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="box-body">
                    @include('cotizacionAprobarCliente.form')
                </div>
                <!-- /.box-body -->
