...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/dteguiadespnv/index.js")}}" type="text/javascript"></script>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Guia Directa Nota Venta DTE</h3>
                <div class="box-tools pull-right">
                    <a href="{{route('listarnv_dteguiadespnv')}}" class="btn btn-block btn-success btn-sm">
