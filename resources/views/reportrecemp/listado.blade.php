				...
				<div class="round">
					...
					<table style="width:100%; border-collapse:collapse;">
						<tr>
							...
							<td style="width:40%; word-wrap:break-word; vertical-align:top; padding-right:15px;">{{ substr($nm_empleado->emp_nac, 0, 1) . '-' . number_format((int)$nm_empleado->emp_ced, 0, '', '.') }}</td>
