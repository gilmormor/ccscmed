...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			...
			<td class="info_factura">
				<div class="round">
					<span class="h3">Libro de Ventas</span>
	...
	<div class="round">
		<table id="factura_detalle" style="table-layout:fixed;width: 100%;">
			<thead>
				<tr>
					<th style='text-align:center;width: 5% !important;'>Centro Eco</th>
					<th style='text-align:center;width: 6% !important;'>Doc</th>
					<th style='text-align:center;width: 7% !important;'>Fecha</th>
					<th style='text-align:center;width: 7% !important;'>Número</th>
					<th style='text-align:center;width: 7% !important;'>FechaVenc</th>
			...
			<tbody id="detalle_productos">
				...
				@foreach($datas as $data)
					<tr class='btn-accion-tabla tooltipsC'>
						<td style='text-align:center;width: 5% !important;font-size: 8px;'>{{$data->sucursal_nombre}}</td>
						<td style='text-align:center;width: 5% !important;'>{{$data->foliocontrol_doc}}</td>
						...
						<td style='text-align:center;width: 5% !important;'>{{date("d/m/Y", strtotime($data->fchvenc))}}</td>							
