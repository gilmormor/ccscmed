    ...
    <div class="col-xs-12 col-sm-12">
        <div class="row">
            <div class="form-group col-xs-12 col-sm-1">
                <label for="nrodoctoF" class="control-label requerido" data-toggle='tooltip' title="Número de Factura">Factura</label>
                <input type="text" name="nrodoctoF" id="nrodoctoF" class="form-control" style="padding-left: 4px;padding-right: 4px;" value="{{old('nrodoctoF', $data->nrodocto ?? '')}}" required/>
            </div>
            ...
            <div class="form-group col-xs-12 col-sm-3">
                ...
                <input type="text" name="direccion" id="direccion" class="form-control" value="{{old('direccion', $data->direccion ?? '')}}" required placeholder="Dirección principal" readonly/>
            </div>
            <div class="form-group col-xs-12 col-sm-1">
                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data" style="font-size:14px">
                    ...
                    <tfoot style="display:none;" id="foottotal" name="foottotal">
                        <div id="foot">
                            ...
                            <tr id="trtotalrestante" name="trtotalrestante">
