        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id='tabla-data-guiadespacho' name='tabla-data-guiadespacho' class='table display AllDataTables table-hover table-condensed tablascons' data-page-length='50'>
