...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/dteguiadespanular/listarguiadesp.js")}}" type="text/javascript"></script>
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary collapsed-box">
            <div class="box-header with-border">
                <h3 class="box-title">Guia Despacho por Facturar</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                </div>
                <div class="box-tools pull-right">
                    <a href="{{route('dteguiadespanular')}}" class="btn btn-block btn-info btn-sm">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <table id="tabla-data-guiadesp" name="tabla-data-guiadesp" class="table display AllDataTables table-hover table-condensed tablascons" style="width:100%">
                        <thead>
                            <tr>
