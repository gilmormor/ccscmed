    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Consultar Rechazo Orden Despacho</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-9 col-sm-12">
                        ...
                        <div class="col-xs-12 col-md-12 col-sm-12">
                            <div class="col-xs-12 col-sm-6" data-toggle='tooltip' title="Id Rechazo">
                                <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                    <label for="id">Id Rechazo:</label>
                                </div>
                                <div class="col-xs-12 col-md-8 col-sm-8">
                        ...
                        <div class="col-xs-12 col-md-12 col-sm-12">
                            <div class="col-xs-12 col-sm-6" data-toggle='tooltip' title="Nro. Guia Despacho">
                                <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                    <label for="guiadespacho">Guia Despacho:</label>
                                </div>
                                <div class="col-xs-12 col-md-8 col-sm-8">
                                    <input type="text" name="guiadespacho" id="guiadespacho" class="form-control" value="{{old('guiadespacho')}}" maxlength="12"/>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6" data-toggle='tooltip' title="Nro Factura">
                                <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                    <label for="numfactura">Factura:</label>
                                </div>
                                <div class="col-xs-12 col-md-8 col-sm-8">
                                    <input type="text" name="numfactura" id="numfactura" class="form-control" value="{{old('numfactura')}}" maxlength="10"/>
                                </div>
                            </div>
                        </div>
