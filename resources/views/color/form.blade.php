...
<div class="form-group">
    <label for="codcolor" class="col-lg-3 control-label requerido">Color</label>
    <div class="col-lg-9">
    <input type="color" name="codcolor" id="codcolor" class="form-control" value="{{old('codcolor', $data->codcolor ?? '')}}" required/>
    </div>
</div>