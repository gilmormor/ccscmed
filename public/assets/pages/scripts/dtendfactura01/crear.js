...
function llenarItemFact(data){
	...
	for (i = 0; i < data.length; i++) {
		htmlTags = '<tr name="fila' + data[i].id + '" id="fila' + data[i].id + '" class="proditems ' + data[i].nrodocto + '">' +
			...
			'</td>' +
			'<td name="nombreProdTD' + data[i].id + '" id="nombreProdTD' + data[i].id + '" valor="' + data[i].nmbitem + '">' +
					data[i].nmbitem +
				'<input type="text" name="nmbitem[]" id="nmbitem' + data[i].id + '" class="form-control" value="' + data[i].nmbitem + '" style="display:none;"/>' +
			...
			'<td name="subtotalFactDet' + data[i].id + '" id="subtotalFactDet' + data[i].id + '" class="subtotalFactDet" style="text-align:right">' +
				'<input type="text" name="montoitem[]" id="montoitem' + data[i].id + '" class="form-control numerico calpreciounit" value="' + data[i].montoitem + '" valor="' + data[i].montoitem + '" valorini="' + data[i].montoitem + '"item="' + data[i].id + '" style="text-align:right"/>' +
			'</td>' +
			'<td name="subtotalSFTD' + data[i].id + '" id="subtotalSFTD' + data[i].id + '" class="subtotal" style="text-align:right;display:none;">' +
				data[i].montoitem +
			'</td>' +
...
function llenarDatosCliente(respuesta){
	...
	$("#foliocontrol_id").val(respuesta.dte[0].foliocontrol_id);
