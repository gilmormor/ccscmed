$(document).ready(function () {
    ...
    $('#tabla-data').DataTable({
        ...
        'columns'     : [
            ...
            {defaultContent : 
                "<a class='btn-accion-tabla btn-sm btngenpdfNV1 tooltipsC' title='Nota de venta'>" +
        ...
        "createdRow": function ( row, data, index ) {
            ...
            if( codigo == null || codigo.length == 0 || /^\s+$/.test(codigo)){
                ...
                aux_text = 
                "<a href='#' onclick='genpdfCOT(\"" + data.cotizacion_id + "\",1)'>" + data.cotizacion_id + "</a>";
            }
