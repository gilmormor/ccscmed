...
INSERT INTO `region` (`id`,`nombre`,`ordinal`,`orden`)
VALUES
	...
	(5,'Coquimbo','IV',4),
	(6,'Valparaiso','V',5),
	(7,'Metropolitana de Santiago','RM',0),
	(8,'Libertador General Bernardo O\'Higgins','VI',6),
	(9,'Maule','VII',7),
	(10,'Biobío','VIII',8),
	(11,'La Araucanía','IX',9),
	(12,'Los Ríos','XIV',14),
	(13,'Los Lagos','X',10),
	(14,'Aisén del General Carlos Ibáñez del Campo','XI',11),
	(15,'Magallanes y de la Antártica Chilena','XII',21);
