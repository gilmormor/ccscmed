...
class CreateTableAcuerdotecnicotemp extends Migration
{
    ...
    public function up()
    {
        Schema::create('acuerdotecnicotemp', function (Blueprint $table) {
            ...
            $table->foreign('at_color_id','fk_acuerdotecnicotemp_color')->references('id')->on('color')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('at_materiaprima_id','fk_acuerdotecnicotemp_materiaprima')->references('id')->on('materiaprima')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('at_anchoum_id','fk_acuerdotecnicotemp_anchounidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('at_largoum_id','fk_acuerdotecnicotemp_largounidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('at_fuelleum_id','fk_acuerdotecnicotemp_fuelleunidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('at_espesorum_id','fk_acuerdotecnicotemp_espesorunidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
