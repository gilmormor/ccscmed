...
class ModificarTableCotizaciondetalle extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('cotizaciondetalle', function (Blueprint $table) {
            ...
            $table->foreign('categoriaprod_id','fk_cotizaciondetalle_categoriaprod')->references('id')->on('categoriaprod')->onDelete('restrict')->onUpdate('restrict');
            $table->unsignedBigInteger('claseprod_id')->nullable()->after('categoriaprod_id');
            $table->foreign('claseprod_id','fk_cotizaciondetalle_claseprod')->references('id')->on('claseprod')->onDelete('restrict')->onUpdate('restrict');
            $table->unsignedBigInteger('grupoprod_id')->nullable()->after('claseprod_id');
            $table->foreign('grupoprod_id','fk_cotizaciondetalle_grupoprod')->references('id')->on('grupoprod')->onDelete('restrict')->onUpdate('restrict');
            $table->unsignedBigInteger('color_id')->comment("Color")->nullable()->after('grupoprod_id');
            $table->foreign('color_id','fk_cotizaciondetalle_color')->references('id')->on('color')->onDelete('restrict')->onUpdate('restrict');
