...
class CreateTableEstadisticaventagi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('estadisticaventagi', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->bigIncrements('id');
            $table->unsignedBigInteger('sucursal_id')->comment("Id de Sucursal");
            $table->foreign('sucursal_id','fk_estadisticaventagi_sucursal')->references('id')->on('sucursal')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('unidadmedida_id','fk_estadisticaventagi_unidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
    ...
    {
        Schema::dropIfExists('estadisticaventagi');
    }
}
